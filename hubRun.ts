...
export const siteMeta = {
  ...
  year: 2026,
  registration: '9Y-KWB',
  /* the masthead mark links back to the main site */
...
export const sorties: Sortie[] = [
  {
    id: 'trip-01',
    ref: 'Trip 01',
    dates: '11 \u2014 13 July 2026',
    title: 'Three days, three zones, three airlines',
    status: 'flown',
    objective:
      'Deliberately booked as three separate tickets so nothing was protected \u2014 a missed connection would have been mine to solve at the counter. One leg a day, each on a different carrier, dragging the clock three hours east and then all the way back in one hop.',
    tzShift: 3,
    trains: ['timezone', 'multi-carrier'],
    legs: [
      { date: '11 Jul', mode: 'Air', from: 'SFO', to: 'ORD', service: 'UA 1980', carrier: 'United', equipment: '737-900' },
      { date: '12 Jul', mode: 'Air', from: 'ORD', to: 'JFK', service: 'AA 1284', carrier: 'American', equipment: 'A321' },
      { date: '13 Jul', mode: 'Air', from: 'JFK', to: 'SFO', service: 'AS 1387', carrier: 'Alaska', equipment: '737-900' },
    ],
  },
  {
    id: 'trip-02',
    ...
    title: 'Three legs, one day, one of them by road',
    status: 'planned',
    objective:
      'The opposite shape: no time shift at all, everything inside one day, and the middle leg is a car because nobody flies LAX\u2013BUR. Two carriers, two airports forty minutes apart, and the whole thing has to close before the last Burbank departure.',
    tzShift: 0,
    trains: ['sector-density'],
    legs: [
      { date: '12 Sep', mode: 'Air', from: 'SFO', to: 'LAX', service: 'UA 1560', carrier: 'United' },
  ...
  },
  {
    ...
    title: 'Ultra-long, three days, two continents',
    status: 'planned',
    objective:
      'Nine hours of shift, an eleven-hour sector each way, and a short domestic hop wedged in the middle while thoroughly jet-lagged. Single carrier throughout, which makes this the easiest of the three on paper and the hardest in the body.',
    tzShift: 9,
    trains: ['long-haul', 'timezone'],
    legs: [
      { date: '2 Oct', mode: 'Air', from: 'SFO', to: 'FRA', service: 'LH 455', carrier: 'Lufthansa' },
      { date: '3 Oct', mode: 'Air', from: 'FRA', to: 'MUC', service: 'LH 100', carrier: 'Lufthansa' },
      { date: '4 Oct', mode: 'Air', from: 'MUC', to: 'SFO', service: 'LH 458', carrier: 'Lufthansa' },
    ],
  },
];
...
export const checkride: Sortie = {
  ...
  legs: [
    { date: '24 Oct', mode: 'Air', from: 'SFO', to: 'DEN', service: 'UA 1573', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'DEN', to: 'ORD', service: 'UA 442', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'ORD', to: 'EWR', service: 'UA 1683', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'EWR', to: 'IAD', service: 'UA 3711', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'IAD', to: 'IAH', service: 'UA 1149', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'IAH', to: 'LAX', service: 'UA 1224', carrier: 'United' },
    { date: '24 Oct', mode: 'Air', from: 'LAX', to: 'SFO', service: 'UA 1795', carrier: 'United' },
  ],
};
